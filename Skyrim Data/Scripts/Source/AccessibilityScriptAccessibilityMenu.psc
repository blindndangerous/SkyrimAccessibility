...
Function SortMapMarkers()
    ...
    PapyrusUtil.ResizeObjRefArray(MiscArray, MiscIndex, None)
    PapyrusUtil.ResizeObjRefArray(TownArray, TownIndex, None)
    PapyrusUtil.ResizeObjRefArray(SettlementArray, SettlementIndex, None)
    PapyrusUtil.ResizeObjRefArray(CaveArray, CaveIndex, None)
    PapyrusUtil.ResizeObjRefArray(CampArray, CampIndex, None)
    PapyrusUtil.ResizeObjRefArray(FortArray, FortIndex, None)
    PapyrusUtil.ResizeObjRefArray(NordicRuinsArray, NordicRuinsIndex, None)
    PapyrusUtil.ResizeObjRefArray(DwemerRuinArray, DwemerRuinIndex, None)
    PapyrusUtil.ResizeObjRefArray(ShipwreckArray, ShipwreckIndex, None)
    PapyrusUtil.ResizeObjRefArray(GroveArray, GroveIndex, None)
    PapyrusUtil.ResizeObjRefArray(LandmarkArray, LandmarkIndex, None)
    PapyrusUtil.ResizeObjRefArray(DragonLairArray, DragonLairIndex, None)
    PapyrusUtil.ResizeObjRefArray(FarmArray, FarmIndex, None)
    PapyrusUtil.ResizeObjRefArray(WoodMillArray, WoodMillIndex, None)
    PapyrusUtil.ResizeObjRefArray(MineArray, MineIndex, None)
    PapyrusUtil.ResizeObjRefArray(ImperialCampArray, ImperialCampIndex, None)
    PapyrusUtil.ResizeObjRefArray(StormcloakCampArray, StormcloakCampIndex, None)
    PapyrusUtil.ResizeObjRefArray(DoomstoneArray, DoomstoneIndex, None)
    PapyrusUtil.ResizeObjRefArray(WheatMillArray, WheatMillIndex, None)
    PapyrusUtil.ResizeObjRefArray(StableArray, StableIndex, None)
    PapyrusUtil.ResizeObjRefArray(ImperialTowerArray, ImperialTowerIndex, None)
    PapyrusUtil.ResizeObjRefArray(ClearingArray, ClearingIndex, None)
    PapyrusUtil.ResizeObjRefArray(PassArray, PassIndex, None)
    PapyrusUtil.ResizeObjRefArray(LighthouseArray, LighthouseIndex, None)
    PapyrusUtil.ResizeObjRefArray(OrcStrongholdArray, OrcStrongholdIndex, None)
    PapyrusUtil.ResizeObjRefArray(GiantCampArray, GiantCampIndex, None)
    PapyrusUtil.ResizeObjRefArray(ShackArray, ShackIndex, None)
    PapyrusUtil.ResizeObjRefArray(NordicTowerArray, NordicTowerIndex, None)
    PapyrusUtil.ResizeObjRefArray(NordicDwellingArray, NordicDwellingIndex, None)
    PapyrusUtil.ResizeObjRefArray(DocksArray, DocksIndex, None)
    PapyrusUtil.ResizeObjRefArray(ShrineArray, ShrineIndex, None)
    PapyrusUtil.ResizeObjRefArray(CastleArray, CastleIndex, None)
    PapyrusUtil.ResizeObjRefArray(CapitolArray, CapitolIndex, None)
    PapyrusUtil.ResizeObjRefArray(DLC02Array, DLC02Index, None)
EndFunction
