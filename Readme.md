...
For the full controls reference, see [the controls guide](Docs/src/content/Docs/guides/controls.md).
...
If something does not work, see [the troubleshooting guide](Docs/src/content/Docs/guides/troubleshooting.md).
